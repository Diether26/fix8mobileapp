...
const routes: Routes = [
  ...
  {
    path: 'Home/Electrician-Details/:id',
    loadChildren: () => import('./electrician-details/electrician-details.module').then( m => m.ElectricianDetailsPageModule)
  },
  {
    path:'Home/Electrician-Details/:id/Electrician-Feedback/:id',
